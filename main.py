...
"""Logistic regression is a popular classification algorithm that is 
commonly used for binary classification problems, 
such as detecting AI-generated text. T
he algorithm works by estimating the probability that
 a given input belongs to a certain class.
In the case of detecting AI-generated text, 
you would use logistic regression to estimate the probability
 that a given input is generated by AI."""
